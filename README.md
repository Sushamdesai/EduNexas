...
Course Purchase and Subscription: Integration with Razorpay for purchasing courses and subscriptions. <br />
Interactive Learning: Access to a variety of interactive courses. <br />
User Dashboard: Personalized user dashboard to manage courses and subscriptions. <br />
Admin Dashboard: Administrative features for managing users, courses, and transactions. <br />
### Tech Stack <br />
Frontend: React.js <br />
Backend: Node.js, Express.js <br />
Database: MongoDB <br />
Authentication: OTP-based authentication <br />
